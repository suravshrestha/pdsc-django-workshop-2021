...
class Account:
    ...
    def __init__(self, name, balance, pin):
        ...
        print(
            f"Congrats {name}, your account has been opened. Your account number is {ac_n} and your pin is {pin}")
    ...
    def transfer(self, pin, pathauna_aateko_manxe_ko_naam, reciever_ac_n, amount):
        if pin == self.pin:
            # {key: value} dct.get(key) => if key exists: value... if key doesn't exist: None
            if accounts.get(reciever_ac_n) != None:
                if self.balance >= amount:
                    ...
                    if reciever.name == pathauna_aateko_manxe_ko_naam:
                        ...
                        print(
                            f"Your transfer has been successful. Your new balance is Rs {self.balance}.")
...
my.transfer(pin=123, pathauna_aateko_manxe_ko_naam="Abisam",
            reciever_ac_n=2, amount=1200)
